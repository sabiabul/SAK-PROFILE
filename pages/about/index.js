...
const About = () => {
  ...
  return (
  <div className="h-[600px] bg-primary/30 py-32 
  text-center xl:text-left">
   ...
   justify-center'>
   <motion.h2 variants={fadeIn('left', 0.4)} 
   initial='hidden' 
   animate="show" 
   exit="hidden" 
   className='h2'> 
    Captivating <span className='text-accent'>stories</span> birth
magnificent designs.</motion.h2>
...
className='max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0'>
  10 years kjsdfnsd  skdjnfksdnf sdfnsdkfnksdnf sdjfjnksdnf sdjkfnksdnfk jksdfnksdnf ksdjfn
...
<div className='flex flex-1 xl:gap-x-6'>
  ...
  font-extrabold text-accent mb-2'>
